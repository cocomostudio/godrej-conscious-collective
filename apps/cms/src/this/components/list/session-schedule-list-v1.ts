...
/**
 ...
 |
 | **The component in the catalogue that stores nothing.** An editor places
 | it and that is the whole of the decision: which sessions it shows follows
 | from the event the page resolved to, and every session of that event is
 | shown because a schedule that left some out would not be a schedule.
 |
